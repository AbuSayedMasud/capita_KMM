                ...
                Row(
                    ...
                    Column(
                        ...
                        if (expandedState.value && cardName == "instrument") {
                            Icon(
                                painter = painterResource(id = com.leads.capitabull.android.R.drawable.baseline_keyboard_arrow_up_24),
                                contentDescription = null,
                                tint = contentColor,
                            )
                        } else {
                            Icon(
                                painter = painterResource(id = com.leads.capitabull.android.R.drawable.baseline_keyboard_arrow_down_24),
                                contentDescription = null,
                                tint = contentColor,
                            )
                        }
